...
WeatherVis.prototype.filterAndAggregate = function(_option){
	...
	for (i = 0; i < filteredData.length; i++) {
		if (dateFormatter.parse(filteredData[i].time) < dateFormatter.parse("2021-12-31 01:00") && dateFormatter.parse(filteredData[i].time) >= dateFormatter.parse("2016-01-01 01:00")) {
